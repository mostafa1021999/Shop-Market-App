...
class PageCubit extends Cubit<PageState> {
  ...
  List<BottomNavigationBarItem> bottom = [
    const BottomNavigationBarItem(icon:  Icon(Icons.home,color: Colors.white),
      label: 'Home',
      backgroundColor: Colors.deepOrange,
    ),
    const BottomNavigationBarItem(icon: Icon(Icons.apps_outlined,color: Colors.white,),
      label: 'Categories',
      backgroundColor: Colors.deepOrange,
    ),
    const BottomNavigationBarItem(icon: Icon(Icons.shopping_cart,color: Colors.white),
      label: 'Chart',
      backgroundColor: Colors.deepOrange,
    ),
    const BottomNavigationBarItem(icon: Icon(Icons.favorite,color: Colors.white),
      label: 'Favorite',
      backgroundColor: Colors.deepOrange,
    ),
    const BottomNavigationBarItem(icon: Icon(Icons.settings,color: Colors.white),
      label: 'settings',
      backgroundColor: Colors.deepOrange,
    ),
  ];
